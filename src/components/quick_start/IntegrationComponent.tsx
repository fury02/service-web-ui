...
class IntegrationComponent extends React.Component {
                ...
                <Container>
                    ...
                    <Row>
                        <Col>
                            ...
                            Service ID: {this.state.service_canister_id}
                            <h6 className="text-lg-start">
    ...
    /*<h6 className="text-lg-start"><small className="text-muted">Creating an actor to interact with the service.  and address: "https://boundary.ic0.app". Detailed information on creating an actor can be found in the documentation.</small></h6>*/
